...
//		}
	...
	private static void loadProperties() {
		if(properties == null) {
			...
			try {
				properties.load(new FileInputStream("config/FuzzyCrawlerConfig.prop"));
			} catch(FileNotFoundException e) {
				System.err.println("Can't load properties file: " + e.getMessage());
				System.exit(1);
			} catch(IOException e) {
				System.err.println("IOException loading properties file: " + e.getMessage());
				System.exit(1);
			}
		}
	}
...
//			for(int i=0; i < Integer.parseInt(properties.getProperty("URIIterations")); i++) {
